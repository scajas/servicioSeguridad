...
/**
 * <p>Clase Java para enviarCargaResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="enviarCargaResponse">
 *   &lt;complexContent>
...
@XmlType(name = "enviarCargaResponse", propOrder = {
    "_return"
})
public class EnviarCargaResponse {
