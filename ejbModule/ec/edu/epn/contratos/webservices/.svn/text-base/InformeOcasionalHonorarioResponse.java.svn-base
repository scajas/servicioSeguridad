...
/**
 * <p>Clase Java para informeOcasionalHonorarioResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="informeOcasionalHonorarioResponse">
 *   &lt;complexContent>
...
@XmlType(name = "informeOcasionalHonorarioResponse", propOrder = {
    "_return"
})
public class InformeOcasionalHonorarioResponse {
