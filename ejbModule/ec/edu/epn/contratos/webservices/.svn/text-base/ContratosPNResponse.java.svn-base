...
/**
 * <p>Clase Java para contratosPNResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="contratosPNResponse">
 *   &lt;complexContent>
...
@XmlType(name = "contratosPNResponse", propOrder = {
    "_return"
})
public class ContratosPNResponse {
