...
/**
 * The persistent class for the plan15b database table.
 * 
 */
@Entity
@NamedQuery(name="Plan15b.findAll", query="SELECT p FROM Plan15b p")
public class Plan15b implements Serializable {
